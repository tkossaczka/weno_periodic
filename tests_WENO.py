...
train_model = torch.load("C:/Users/Tatiana/Desktop/Research/Research_ML_WENO/Burgers_Equation_Test/Models/Model_40/13.pt")
...
my_problem.initial_condition, _, _, _, _, _ = init_cond_B(3, my_problem.x, 1)
