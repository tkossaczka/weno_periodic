...
u_ex_whole = np.load("C:/Users/Tatiana/Desktop/Research/Research_ML_WENO/Burgers_Equation_Test/Test_set_additional/u_exact_0.npy")
u_ex = u_ex_whole[0:1024 + 1: 8]

space_steps = 128
problem_main = problem(ic_numb=4, space_steps=space_steps, time_steps=None, params=None)
...
np.save("C:/Users/Tatiana/Desktop/Research/Research_ML_WENO/Burgers_Equation_Test/Test_set_additional/u_exact_0.npy", u_nt)
