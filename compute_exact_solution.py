...
def save_problem_and_solution(save_path, sample_id):
    ...
    problem_ex = problem(ic_numb=ic_id, space_steps=512, time_steps=None, params=None)
    #width = problem_ex.width
    #height = problem_ex.height
    k = problem_ex.k
    #C = problem_ex.params["C"]
    u_exact, u_exact_64 = train_model.compute_exact(problem, problem_ex, 64, 25, just_one_time_step=False, trainable=False)
