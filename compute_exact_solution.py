...
def save_problem_and_solution(save_path, sample_id):
    ...
    k = problem_ex.k # Burgers
    # C = problem_ex.params["C"]  #Buckley
    # u_exact, u_exact_128 = train_model.compute_exact(problem, problem_ex, 64*2, 140, just_one_time_step=False, trainable=False) #Buckley
    u_exact, u_exact_128 = train_model.compute_exact(problem, problem_ex, 64*2, 100, just_one_time_step=False, trainable=False) #Burgers
...
if __name__ == "__main__":
    ...
    # usage example: seq 61 100 | xargs -i{} -P6 python compute_exact_solution.py C:\Users\Tatiana\Desktop\Research\Research_ML_WENO\Buckley_Leverett_Test\Buckley_Leverett_Data_1024 {}
    # seq 0 90 | xargs -i{} -P6 python compute_exact_solution.py C:\Users\Tatiana\Desktop\Research\Research_ML_WENO\Burgers_Equation_Test\Burgers_Equation_Data_1024_final {}
