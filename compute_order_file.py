...
with torch.no_grad():
    ...
    err_trained, order_trained = train_model.order_compute(5, 10, None,  params, problem, trainable=True, ic_numb=2)
    err_not_trained, order_not_trained = train_model.order_compute(5,10,None, params, problem, trainable=False, ic_numb=2)