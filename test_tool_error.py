...
for j in range(rng):
    sample_id = ll
    u_ex = np.load("C:/Users/Tatiana/Desktop/Research/Research_ML_WENO/Buckley_Leverett_Test/Buckley_Leverett_Data_2/Test_set/u_exact64_{}.npy".format(sample_id))
    #u_ex = np.load("C:/Users/Tatiana/Desktop/Research/Research_ML_WENO/Burgers_Equation_Test/Burgers_Equation_Data_2/Test_set/u_exact64_{}.npy".format(sample_id))
